...
for guide in guides:
  if user_data == guide["pk"]:
    suitable_person.append(guide["fields"])

num_1 = suitable_person[0]["full_name"]
num_2 = suitable_person[0]["tours_count"]
num_3 = suitable_person[0]["bio"]

print(f"""{num_1}, туров: {num_2}
{num_3}""")